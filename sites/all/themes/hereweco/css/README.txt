...
To use these stylesheets, rename the files and hereweco with the name of your theme.
...
hereweco-alpha-default-narrow.css  
...
hereweco-alpha-default-normal.css
...
hereweco-alpha-default-wide.css
